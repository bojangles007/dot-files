...
* mu4e Setup
  ...
  #+BEGIN_SRC emacs-lisp
    ...
    (add-to-list 'mu4e-bookmarks
                 '("flag:unread AND MAILDIR:/Work* AND NOT maildir:/Work/[Gmail]*" "Work Unread Messages" ?W))
    (add-to-list 'mu4e-bookmarks
                 '("flag:unread AND MAILDIR:/Private* AND NOT maildir:Deleted* AND NOT maildir:/Private/Sent* AND NOT maildir:/Private/Junk" "Private Unread Messages" ?P))
    (add-to-list 'mu4e-bookmarks
                 '("flag:unread AND NOT maildir:/Work/[Gmail]* AND NOT maildir:/Private/Deleted* AND NOT maildir:/Private/Sent* AND NOT maildir:/Private/Junk" "All Unread Messages" ?u))
  #+END_SRC

  Tell mu4e to get new mail with mbsync.
