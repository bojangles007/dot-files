...
** Composing & Sending Email
   ...
   Discourage HTML & Rich Text messages.
   ...
   #+BEGIN_SRC emacs-lisp
     (setq smtp-accounts
           '(("stig@brautaset.org" "mailbox@brautaset.org" "mail.gandi.net")
             ("stig.brautaset@icloud.com" "stig.brautaset@icloud.com" "smtp.mail.me.com")
             ("sbrautaset@gmail.com" "sbrautaset@gmail.com" "smtp.gmail.com")
...
** Gists
   ...
   #+BEGIN_SRC emacs-lisp
     (use-package gist
       :ensure t
       :bind (("C-x g c" . gist-region-or-buffer-private)
              ("C-x g l" . gist-list)))
   #+END_SRC
...
** Email support
   ...
   I like to be able to read HTML email. Even in Gnus.
   ...
   For this we require the w3m browser to be installed via brew.
